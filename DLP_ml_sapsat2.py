...
import numpy as np
import lib.read_sapsat as read
import lib.dlp_sapsat as dlp
...
if __name__ == '__main__': # "protect my main loop" (https://pythonhosted.org/joblib/parallel.html) but also useful on mac (and seems to indeed make it a bit faster)
    ...
    np.save("../results/Thetahat_SAPSAT2_" + str(T) + ".npy",Thetahat)
...
with open("../tab/Tan_3-4_SAPSAT2_" + str(T) + ".tex", "w") as txt_file:
